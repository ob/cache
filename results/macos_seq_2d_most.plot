...
set ylabel "Time (ns)"
plot "MACOS_SEQ_REBOOT" index 1 using 1:3 with lines title "8K", \
     ...
     "MACOS_SEQ_REBOOT" index 9 using 1:3 with lines title "2M", \
     ...
     "MACOS_SEQ_REBOOT" index 18 using 1:3 with lines title "1GB"
